/* eslint-disable @typescript-eslint/no-explicit-any,@typescript-eslint/explicit-function-return-type,@typescript-eslint/explicit-member-accessibility */
// Copyright (C) 2020, Orkhan Alikhanov <http://orkhanalikhanov.com>. All rights reserved.
//source: https://github.com/OrkhanAlikhanov/prosemirror-image-uploader/blob/master/src/lib/ImageUploaderPlugin.ts
